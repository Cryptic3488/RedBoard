...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col">
          ...
          {role === 'admin' && (
            <NavLink
              ...
              className="font-ui text-xs text-gray-500 hover:text-near-black px-2.5 py-1 rounded
                         border border-gray-200 hover:border-gray-600 transition-colors"
            >
              Admin
            </NavLink>
          )}
      ...
      {/* Bottom nav */}
      <nav className="fixed bottom-0 inset-x-0 bg-white backdrop-blur border-t border-gray-200/60 flex z-10">
              ...
              <>
                <span className="relative inline-flex text-xl leading-none mb-0.5">
                  ...
                  {to === '/app/feed' && role === 'player' && unreadCount > 0 && (
                    <span className="absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-brand ring-1 ring-cream" />
                  )}
                </span>
